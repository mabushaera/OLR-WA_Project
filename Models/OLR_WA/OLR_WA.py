...
def olr_wa_regression(X, y, w_base, w_inc, base_model_size, increment_size):
    """
...
def olr_wa_regression_(X, y, w_base, w_inc, base_model_size, increment_size):
    """
        Perform Online Linear Regression with Weighted Averaging (OLR-WA).
...
def olr_wa_regression_KFold(X, y, w_base, w_inc, base_model_size, increment_size, seed):
    """
...
def olr_wa_regression_KFold_(X, y, w_base, w_inc, base_model_size, increment_size, seed):
    """
        Perform K-Fold cross-validation with Online Linear Regression and Weighted Averaging.
...
def olr_wa_convergence2(X, y, w_base, w_inc, base_model_size, increment_size,model_name, seed):
    ...
    for fold_index, (train_index, test_index) in enumerate(kf.split(X)):
        X_train, X_test = X[train_index], X[test_index]
        y_train, y_test = y[train_index], y[test_index]
        w, olr_wa_map = olr_wa_plot_convergence2(X_train, y_train, X_test, y_test, w_base, w_inc, base_model_size, increment_size,
                            model_name)
