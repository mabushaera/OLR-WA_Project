...
def online_ridge_regression(X, y, learning_rate, epochs, regularization_param):
    """
...
def online_ridge_regression_KFold(X, y, learning_rate, epochs, regularization_param, seed):
    """
...
def online_ridge_regression_convergence2(X, y,
    ...
    for fold_index, (train_index, test_index) in enumerate(kf.split(X)):
        X_train, X_test = X[train_index], X[test_index]
        y_train, y_test = y[train_index], y[test_index]
        w, b, orr_map = online_ridge_regression_plot_convergence2(X_train, y_train, learning_rate, epochs, regularization_param, X_test, y_test, model_name)
