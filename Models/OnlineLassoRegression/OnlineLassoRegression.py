...
def online_lasso_regression(X, y, learning_rate, epochs, regularization_param):
    """
...
def online_lasso_regression_KFold(X, y, learning_rate, epochs, regularization_param, seed):
    """
...
def online_lasso_regression_plot_convergence2(X, y, learning_rate, epochs, regularization_param, X_test, y_test,
    ...
    return w, bias, olr_map


def online_lasso_regression_convergence2(X, y, learning_rate, epochs, regularization_param, model_name, seed):
    n_splits = 5
    kf = KFold(n_splits=5, random_state=seed, shuffle=True)
    olr_list = []
    for fold_index, (train_index, test_index) in enumerate(kf.split(X)):
        X_train, X_test = X[train_index], X[test_index]
        y_train, y_test = y[train_index], y[test_index]
        w, b, olr_map = online_lasso_regression_plot_convergence2(X, y, learning_rate, epochs, regularization_param, X_test, y_test, model_name)
