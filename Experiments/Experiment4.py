...
def experiment4Main():
    ...
    regression model using K-Fold cross-validation on a synthetic dataset with specified parameters.
    ...
    # 1. Experiments
    for seed in SEEDS:
        X, y = SyntheticDS.create_dataset(n_samples=hm, n_features=n, noise=noise, shuffle=True, random_state=seed)
        ...
        #                                       Hyperparameter.olr_wa_increment_size(n, user_defined_val=100), seed)
        # end_time = time.perf_counter()
