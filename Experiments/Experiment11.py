...
def experiment11Main():
    """
        ...
        - Dataset: Synthetic dataset with specified parameters. DS7
        - Models:
    ...
    for seed in SEEDS:
        ...
        # 8. RLS
        start_time = time.perf_counter()
        rls_acc = RLS.rls_adversarial(X, y, X_test, y_test, Hyperparameter.rls_lambda_2, Hyperparameter.rls_delta)
        end_time = time.perf_counter()
